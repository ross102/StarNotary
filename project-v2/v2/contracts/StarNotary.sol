...
contract StarNotary is ERC721 {
    ...
    string public name = "Golden Star";
    string public symbol = "GSN";
    ...
    function exchangeStars(uint256 _tokenId1, uint256 _tokenId2) public {
        ...
        require(((ownerOf(_tokenId1) == msg.sender) || (ownerOf(_tokenId2) == msg.sender)) , "should be owner of atleast one token");
    ...
    function transferStar(address _to1, uint256 _tokenId) public {
         ...
         require(ownerOf(_tokenId) == msg.sender, "msg sender should be owner of the Star");
